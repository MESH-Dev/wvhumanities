...
<div class="tribe-events-list-event-all">
	...
	<?php the_title( '<h2 class="tribe-events-list-event-title entry-title summary"><a class="url" href="<?php echo tribe_get_event_link() ?>" title="<?php echo stripslashes(get_the_title()); ?>" rel="bookmark">', '</a></h2>' ); ?>
